...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full min-h-screen flex-col items-center overflow-hidden bg-background z-0",
        className
      )}
    >
      <div className="relative mt-48 flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 w-[30rem] bg-gradient-conic from-purple-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute pb-4 inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-purple-400 blur-2xl"
        />
        <motion.div
          initial={{ width: "15rem" }}
